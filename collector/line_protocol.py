"""InfluxDB line-protocol builders for ADS-B measurements.

Public interface: build_lines, build_lines_978, build_lines_airspy.
Individual builders (messages_line, aircraft_line, etc.) are also public
and useful when a caller only wants a single measurement.
"""
